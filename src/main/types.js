...
export const Constants = {
    ...
    */
    VOICE_ERROR_TYPE: {
        ...
        AREA_CODE_NOT_IN_DIALABLE_LIST: constants.VOICE_ERROR_TYPE.AREA_CODE_NOT_IN_DIALABLE_LIST,
        PHONE_NUMBER_NOT_VALID: constants.VOICE_ERROR_TYPE.PHONE_NUMBER_NOT_VALID,
        PHONE_NUMBER_NOT_VALID_E164_FORMAT: constants.VOICE_ERROR_TYPE.PHONE_NUMBER_NOT_VALID_E164_FORMAT,
        UNAUTHORIZED_SERVICE_CALL: constants.VOICE_ERROR_TYPE.UNAUTHORIZED_SERVICE_CALL,
        AGENT_AT_MAXIMUM_CAPACITY: constants.VOICE_ERROR_TYPE.AGENT_AT_MAXIMUM_CAPACITY,
        OUTBOUND_QUEUE_MISCONFIGURED: constants.VOICE_ERROR_TYPE.OUTBOUND_QUEUE_MISCONFIGURED,
        CALL_THROTTLED: constants.VOICE_ERROR_TYPE.CALL_THROTTLED,
        TIMEOUT_ERROR: constants.VOICE_ERROR_TYPE.TIMEOUT_ERROR,
        UNABLE_TO_CONNECT_TO_AGENT: constants.VOICE_ERROR_TYPE.UNABLE_TO_CONNECT_TO_AGENT,
        AGENT_NOT_INITIALIZED: constants.VOICE_ERROR_TYPE.AGENT_NOT_INITIALIZED
    },
    /**
    * @enum {string}
    */
...
export class HoldToggleResult {
     ...
     * @param {object} param
     * @param {boolean} [param.isThirdPartyOnHold] - Deprecated. Whether the third party is on hold.
     * @param {boolean} param.isCustomerOnHold
     * @param {PhoneCall[]} param.calls - Required. One or more calls.
...
export class Contact {
     ...
     * @param {typeof Constants.CONTACT_TYPE[keyof typeof Constants.CONTACT_TYPE]} [param.type] - The type of the contact, one of the CONTACT_TYPE values
...
export class PhoneCallAttributes {
     ...
     * @param {typeof Constants.PARTICIPANT_TYPE[keyof typeof Constants.PARTICIPANT_TYPE]} [param.participantType] - Deprecated. The participant type of the call. Will be removed in a future version.
...
export class VendorConnector {
     ...
     * @param {typeof Constants.LOG_LEVEL[keyof typeof Constants.LOG_LEVEL]} logLevel Log Level (INFO, ERROR)
